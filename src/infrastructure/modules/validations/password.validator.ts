...
import { PasswordValidationRequirement } from './validations.objects';
...
export function IsPasswordValid(property: PasswordValidationRequirement, validationOptions?: ValidationOptions) {
...
export class PasswordValidation implements ValidatorConstraintInterface {
  ...
  defaultMessage(args: ValidationArguments) {
    ...
    if (relatedValue.mustContainSpecialCharacter) {
      if (!StringUtilities.containsSpecialCharacter(value)) return 'Password must contain special characters';
    }
